package BPlusTree;// Searching on a B+ tree in Java
...
public class BPlusTree {
    ...
    private void printTreeHelper(Node node, int level) {
        if (node instanceof LeafNode) {
            ...
            System.out.println("Leaf Node - Level " + level);
            for (int i = 0; i < leafNode.numPairs; i++) {
                System.out.println("Key: " + leafNode.dictionary[i].key + ", Value: " + leafNode.dictionary[i].value);
            }
        } else if (node instanceof InternalNode) {
            InternalNode internalNode = (InternalNode) node;
            System.out.println("Internal Node - Level " + level);
            ...
            for (int i = 0; i < internalNode.degree; i++) {
                printTreeHelper(internalNode.childPointers[i], level + 1);
            }
        }
    }
